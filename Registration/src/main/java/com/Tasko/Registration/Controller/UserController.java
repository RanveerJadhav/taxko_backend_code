...
@GetMapping("/sumOFPaymentClientByUserid/{userid}/{year}")
public Map<String, Object> getPaymentSumsByUserid(@PathVariable Long userid,@PathVariable String year)
{
	return taskoService.getPaymentSumsByUserid(userid,year);
