...
public class Create_Invoice_data {
	...
	public String toString() {
		return "Create_Invoice_data [id=" + id + ", invoiceid=" + invoiceid + ", supplytype=" + supplytype
	...
	public Create_Invoice_data(Long id, Long invoiceid, String supplytype, String subtype, String documenttype,
