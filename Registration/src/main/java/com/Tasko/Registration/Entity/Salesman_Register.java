...
@Entity
public class Salesman_Register {
	@Id
	...
	public String toString() {
		return "Salesman_Register [id=" + id + ", name=" + name + ", datebirth=" + datebirth + ", profession="
	...
	public Salesman_Register(Long id, @NotBlank(message = "Name is mandatory") String name, Date datebirth,
